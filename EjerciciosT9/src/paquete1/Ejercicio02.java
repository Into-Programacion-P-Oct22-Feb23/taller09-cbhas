/*Lo que hicimos para poner los valores fuera de rango fue crear aumantar el 
rango para poner ("-1-200") y así poder crear otra cadena "Si y De lo contrario"*/
...
public class Ejercicio02 {
    ...
    public static void main(String[] args) {
        ...
        String[] rangos = {"1-5", "6-10", "11-15", "16-20", "-1-200"};
